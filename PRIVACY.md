...
To disable this, simply remove the following section from [deploy.json](./Deployment/deploy.json) and [deploykeyvault.json](./Deployment/deploykeyvault.json) before deploying the resources to Azure:
